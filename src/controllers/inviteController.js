...
// //     } else {
// //       // 3️⃣ Create new user with "Member" role
// //       const hashedPassword = await bcrypt.hash(password, 12);
// //       const userRes = await client.query(
// //         `INSERT INTO users (email, password_hash, role)
// //          VALUES ($1, $2, 'Member') RETURNING id`,
// //         [invite.email, hashedPassword, "Member"]
// //       );
// //       userId = userRes.rows[0].id;
// //     }

// //     // 4️⃣ Link user to all workspaces owned by the inviting admin
...
// //       return res
// //         .status(400)
// //         .json({ message: "No workspaces found for the inviting admin" });
// //     }
...
// //     // 5️⃣ Ensure user is not linked as an owner in these workspaces
// //     await client.query(
// //       `DELETE FROM workspace_owners WHERE user_id = $1 AND workspace_id IN (
// //         SELECT id FROM workspaces WHERE owner_id = $2
// //       )`,
// //       [userId, invite.sent_by]
// //     );
...
// //       .status(201)
// //       .json({
// //         message: "User linked to inviting admin's workspaces as member.",
// //       });
// //   } catch (err) {
// //     await client.query("ROLLBACK");
// //     console.error("Accept Invite Error:", err);
...
//         `INSERT INTO users (email, password_hash, role)
//          VALUES ($1, $2, 'Member') RETURNING id`,
//         [invite.email, hashedPassword] // Fixed: Removed extra parameter
//       );
//       userId = userRes.rows[0].id;
//     }
