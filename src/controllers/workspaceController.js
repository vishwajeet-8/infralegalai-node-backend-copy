...
//         u.seat_limit,
//         (
//           -- Count distinct members in workspace_members for owner's workspaces
...
//     // 2. Link owner to this workspace
//     await pool.query(
//       `INSERT INTO workspace_owners (user_id, workspace_id)
//        VALUES ($1, $2)`,
//       [ownerId, newWorkspace.id]
//     );

//     // 3. Get all members already linked to any of this owner's other workspaces
//     const sharedUsers = await pool.query(
//       `
...
//     // 4. Link those members to the new workspace
//     const linkPromises = sharedUsers.rows.map((row) =>
//       pool.query(
...
//     return res.status(201).json({
//       message: "Workspace created and shared with existing members.",
//       workspace: newWorkspace,
//     });
//   } catch (err) {
//     console.error("Create workspace error:", err);
...
//     // Delete related records from workspace_members and workspace_owners
//     await pool.query(`DELETE FROM workspace_members WHERE workspace_id = $1`, [
//       workspaceId,
//     ]);
//     await pool.query(`DELETE FROM workspace_owners WHERE workspace_id = $1`, [
//       workspaceId,
//     ]);
//     await pool.query(`DELETE FROM invites WHERE workspace_id = $1`, [
//       workspaceId,
